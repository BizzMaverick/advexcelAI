            ...
            <h3 style={{ margin: '0 0 15px 0', color: '#333', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <svg width="48" height="48" viewBox="0 0 100 100">
                ...
                <g className="cut" clipPath="url(#clipIt)">
                  ...
                  <path className="bock" d="m 49.533063,13 c 0,0 -4.038975,0.243204 -7.084664,1.6 -10.965877,4.88509 -12.03936,12.900449 -12.029016,15.995361 0.02524,7.552595 4.607455,12.168562 6.129905,13.956538 C 41.41924,50.271203 47.447623,56.491 47.447623,56.491 L 63.320719,42.911532" />
                </g>
              </svg>
              Upload File
            </h3>
